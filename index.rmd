...
Simply select the variable in the first menu and click the corresponding arrow to which variable it should be. Independent variables go into “Covariates” and the dependent variable goes into its corresponding box. After which, the program automatically calculates for the corresponding values and displays them in a table. To create a scatter plot, click “Exploration” seen in Figure n. From there, click “Scatter Plot”.
...
All generated tables and graphs will be shown on the right hand side of the interface shown in Figure n. (replacing the Jamovi logo and version number)
<br>
...
<br>
The data that is important from this table is the r (correlation coefficient) and the p-value. This is all visualized via the scatter plot that was generated.
...
*[placeholder text for conclusion and recommendation]* <!--Replace this with the contents of the actual conclusion-->
<br>
<br>
<br>
<footer>
